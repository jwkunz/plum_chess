...
- `docs/performance_v7.md`
  - Major version 7 search-performance optimization journey and results.
...
- `docs/requirements/v7.md`
  - Locked requirements/spec for the v7 performance optimization effort.
