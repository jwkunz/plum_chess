...
use crate::scoring::{Score, score_game};
...
impl GameState {
    ...
    pub fn get_material_score(&self) -> Result<Score,ChessErrors> {
        score_game(&self, crate::scoring::ScoringTypes::Material(crate::scoring::MaterialScoringTypes::Conventional))
    }
...
mod tests {
    ...
    fn test_fen_parsing() {
        ...
        let score = dut.get_material_score().unwrap();
        assert_eq!(score,0.0);
