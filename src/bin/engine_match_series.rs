...
fn main() -> Result<(), String> {
    ...
    let player1 = || {
        Box::new(plum_chess::engines::engine_iterative_v16::IterativeEngine::new_alpha_zero(6))
            as Box<dyn Engine>
    };
    let player2 = || {
        Box::new(plum_chess::engines::engine_iterative_v16::IterativeEngine::new_standard(6))
            as Box<dyn Engine>
    };
