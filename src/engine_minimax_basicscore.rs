...
use crate::{
    ...
    }, chess_errors::ChessErrors, game_state::GameState, generate_all_moves::generate_all_moves, move_description::MoveDescription, piece_team::PieceTeam, scoring::{BasicScoringObject, CanScoreGame, MAX_SCORE, MIN_SCORE, Score, generate_losing_score}
};
...
/// EngineMinimax::<N>.
pub struct EngineMinimaxBasicScore<const MAX_DEPTH: usize> {
    ...
    /// Scoring object
    scoring_object : BasicScoringObject
}
...
impl<const MAX_DEPTH: usize> ChessEngineThreadTrait for EngineMinimaxBasicScore<MAX_DEPTH> {
    fn configure(
        &mut self,
        starting_position: GameState,
        calculation_time_s: f32,
        ...
        self.scoring_object = BasicScoringObject::new();
    }
...
impl<const MAX_DEPTH: usize> EngineMinimaxBasicScore<MAX_DEPTH> {
    pub fn new(
        starting_position: GameState,
        calculation_time_s: f32,
        command_receiver: mpsc::Receiver<EngineControlMessageType>,
        ...
        EngineMinimaxBasicScore::<MAX_DEPTH> {
            starting_position,
            calculation_time_s,
            command_receiver,
            response_sender,
            ...
            scoring_object: BasicScoringObject::new()
        }
    }
}
