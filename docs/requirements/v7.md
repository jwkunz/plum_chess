...
## Current Status (v7.10.0)

- Steps `v7.0` through `v7.10` are implemented.
- Baseline/performance tooling is available via `benches/v7_perf_criterion.rs`.
...
11. `v7.10`: Hotspot micro-pass (remove redundant TT probe and skip trivial move sorting) with measured before/after update.
