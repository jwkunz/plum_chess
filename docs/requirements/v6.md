...
- Acceptance tooling is in place via `src/bin/v6_acceptance.rs`.
...
10. `v6.9`: Add reproducible acceptance runner (`v6_acceptance`) and from-state harness support to quantify v16 vs v17 strength/speed.
